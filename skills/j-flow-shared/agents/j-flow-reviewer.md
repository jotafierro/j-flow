...
2. `${CLAUDE_SKILL_DIR}/../j-flow-shared/references/code-style.md` — design + implementation constraints to enforce
3. `${CLAUDE_SKILL_DIR}/../j-flow-shared/references/gate-rules.md` — gate statuses
4. `${CLAUDE_SKILL_DIR}/../j-flow-shared/references/layer-order.md` — layer boundaries
5. `${CLAUDE_SKILL_DIR}/../j-flow-shared/references/agent-scopes.md` — what each agent owns (to detect cross-boundary code)
