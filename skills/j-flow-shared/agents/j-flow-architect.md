...
2. `${CLAUDE_SKILL_DIR}/../j-flow-shared/references/code-style.md` — design constraints for specs
3. `${CLAUDE_SKILL_DIR}/../j-flow-shared/references/layer-order.md` — build layer responsibilities
4. `${CLAUDE_SKILL_DIR}/../j-flow-shared/references/gate-rules.md` — gate format
